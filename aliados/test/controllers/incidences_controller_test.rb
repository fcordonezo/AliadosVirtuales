...
class IncidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incidence" do
    assert_difference('Incidence.count') do
      post incidences_url, params: { incidence: { descripcion: @incidence.descripcion, fecha_solucion: @incidence.fecha_solucion } }
    end
  ...
  test "should update incidence" do
    patch incidence_url(@incidence), params: { incidence: { descripcion: @incidence.descripcion, fecha_solucion: @incidence.fecha_solucion } }
